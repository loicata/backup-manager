...
a = Analysis(
    ...
    binaries=[],
    datas=[('F:\\Documents\\loicata\\BackupManager\\Backup Manager v3\\assets\\backup_manager.ico', 'assets'), ('F:\\Documents\\loicata\\BackupManager\\Backup Manager v3\\assets\\License.rtf', 'assets'), ('F:\\Documents\\loicata\\BackupManager\\Backup Manager v3\\assets\\launch.vbs', '.'), ('F:\\Documents\\loicata\\BackupManager\\Backup Manager v3\\assets\\report_signing_key.pem', 'assets'), ('F:\\Documents\\loicata\\BackupManager\\Backup Manager v3\\assets\\server_helper.sh', 'assets')],
