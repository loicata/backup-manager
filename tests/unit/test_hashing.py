...
class TestHashChunkSize:
    ...
    The chunk size is the unit of every read in ``compute_sha256``.
    Too small caps USB/SSD throughput by syscall overhead; 4 MiB is
    the sweet spot for sustained sequential reads on consumer-grade
    external drives.
    """
